...
declare const GetImportJobsCommand_base: {
    new (input: GetImportJobsCommandInput): import("@smithy/smithy-client").CommandImpl<GetImportJobsCommandInput, GetImportJobsCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetImportJobsCommandInput): import("@smithy/smithy-client").CommandImpl<GetImportJobsCommandInput, GetImportJobsCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
