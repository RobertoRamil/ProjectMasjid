...
declare const CreatePushTemplateCommand_base: {
    new (input: CreatePushTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<CreatePushTemplateCommandInput, CreatePushTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreatePushTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<CreatePushTemplateCommandInput, CreatePushTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
