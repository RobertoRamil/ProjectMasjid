...
declare const CreateImportJobCommand_base: {
    new (input: CreateImportJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateImportJobCommandInput, CreateImportJobCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateImportJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateImportJobCommandInput, CreateImportJobCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
