...
declare const CreateVoiceTemplateCommand_base: {
    new (input: CreateVoiceTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<CreateVoiceTemplateCommandInput, CreateVoiceTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateVoiceTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<CreateVoiceTemplateCommandInput, CreateVoiceTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
