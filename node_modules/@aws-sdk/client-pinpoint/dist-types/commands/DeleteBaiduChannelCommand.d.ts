...
declare const DeleteBaiduChannelCommand_base: {
    new (input: DeleteBaiduChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteBaiduChannelCommandInput, DeleteBaiduChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteBaiduChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteBaiduChannelCommandInput, DeleteBaiduChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
