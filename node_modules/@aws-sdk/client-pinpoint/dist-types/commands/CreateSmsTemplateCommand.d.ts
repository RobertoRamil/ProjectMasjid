...
declare const CreateSmsTemplateCommand_base: {
    new (input: CreateSmsTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSmsTemplateCommandInput, CreateSmsTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateSmsTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSmsTemplateCommandInput, CreateSmsTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
