...
declare const DeleteApnsVoipSandboxChannelCommand_base: {
    new (input: DeleteApnsVoipSandboxChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteApnsVoipSandboxChannelCommandInput, DeleteApnsVoipSandboxChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteApnsVoipSandboxChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteApnsVoipSandboxChannelCommandInput, DeleteApnsVoipSandboxChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
