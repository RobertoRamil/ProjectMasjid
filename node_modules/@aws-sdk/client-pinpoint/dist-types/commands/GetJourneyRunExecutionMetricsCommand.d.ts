...
declare const GetJourneyRunExecutionMetricsCommand_base: {
    new (input: GetJourneyRunExecutionMetricsCommandInput): import("@smithy/smithy-client").CommandImpl<GetJourneyRunExecutionMetricsCommandInput, GetJourneyRunExecutionMetricsCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetJourneyRunExecutionMetricsCommandInput): import("@smithy/smithy-client").CommandImpl<GetJourneyRunExecutionMetricsCommandInput, GetJourneyRunExecutionMetricsCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
