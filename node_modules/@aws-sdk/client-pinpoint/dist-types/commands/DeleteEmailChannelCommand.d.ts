...
declare const DeleteEmailChannelCommand_base: {
    new (input: DeleteEmailChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteEmailChannelCommandInput, DeleteEmailChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteEmailChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteEmailChannelCommandInput, DeleteEmailChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
