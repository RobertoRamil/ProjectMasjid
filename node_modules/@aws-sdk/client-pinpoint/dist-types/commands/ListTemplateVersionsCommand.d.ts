...
declare const ListTemplateVersionsCommand_base: {
    new (input: ListTemplateVersionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListTemplateVersionsCommandInput, ListTemplateVersionsCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListTemplateVersionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListTemplateVersionsCommandInput, ListTemplateVersionsCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
