...
declare const GetJourneyExecutionMetricsCommand_base: {
    new (input: GetJourneyExecutionMetricsCommandInput): import("@smithy/smithy-client").CommandImpl<GetJourneyExecutionMetricsCommandInput, GetJourneyExecutionMetricsCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetJourneyExecutionMetricsCommandInput): import("@smithy/smithy-client").CommandImpl<GetJourneyExecutionMetricsCommandInput, GetJourneyExecutionMetricsCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
