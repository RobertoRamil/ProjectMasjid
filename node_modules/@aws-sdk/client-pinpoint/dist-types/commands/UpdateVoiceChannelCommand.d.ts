...
declare const UpdateVoiceChannelCommand_base: {
    new (input: UpdateVoiceChannelCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateVoiceChannelCommandInput, UpdateVoiceChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateVoiceChannelCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateVoiceChannelCommandInput, UpdateVoiceChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
