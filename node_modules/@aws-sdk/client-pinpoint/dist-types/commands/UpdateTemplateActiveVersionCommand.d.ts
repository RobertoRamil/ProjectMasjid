...
declare const UpdateTemplateActiveVersionCommand_base: {
    new (input: UpdateTemplateActiveVersionCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateTemplateActiveVersionCommandInput, UpdateTemplateActiveVersionCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateTemplateActiveVersionCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateTemplateActiveVersionCommandInput, UpdateTemplateActiveVersionCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
