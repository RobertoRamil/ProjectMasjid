...
declare const GetJourneyExecutionActivityMetricsCommand_base: {
    new (input: GetJourneyExecutionActivityMetricsCommandInput): import("@smithy/smithy-client").CommandImpl<GetJourneyExecutionActivityMetricsCommandInput, GetJourneyExecutionActivityMetricsCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetJourneyExecutionActivityMetricsCommandInput): import("@smithy/smithy-client").CommandImpl<GetJourneyExecutionActivityMetricsCommandInput, GetJourneyExecutionActivityMetricsCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
