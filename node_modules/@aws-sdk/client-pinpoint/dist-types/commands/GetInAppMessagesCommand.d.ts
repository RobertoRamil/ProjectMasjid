...
declare const GetInAppMessagesCommand_base: {
    new (input: GetInAppMessagesCommandInput): import("@smithy/smithy-client").CommandImpl<GetInAppMessagesCommandInput, GetInAppMessagesCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetInAppMessagesCommandInput): import("@smithy/smithy-client").CommandImpl<GetInAppMessagesCommandInput, GetInAppMessagesCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
