...
declare const DeleteApnsChannelCommand_base: {
    new (input: DeleteApnsChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteApnsChannelCommandInput, DeleteApnsChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteApnsChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteApnsChannelCommandInput, DeleteApnsChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
