...
declare const GetExportJobsCommand_base: {
    new (input: GetExportJobsCommandInput): import("@smithy/smithy-client").CommandImpl<GetExportJobsCommandInput, GetExportJobsCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetExportJobsCommandInput): import("@smithy/smithy-client").CommandImpl<GetExportJobsCommandInput, GetExportJobsCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
