...
declare const DeleteEmailTemplateCommand_base: {
    new (input: DeleteEmailTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteEmailTemplateCommandInput, DeleteEmailTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteEmailTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteEmailTemplateCommandInput, DeleteEmailTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
