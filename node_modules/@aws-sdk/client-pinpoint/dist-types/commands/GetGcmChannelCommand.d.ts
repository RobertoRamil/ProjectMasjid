...
declare const GetGcmChannelCommand_base: {
    new (input: GetGcmChannelCommandInput): import("@smithy/smithy-client").CommandImpl<GetGcmChannelCommandInput, GetGcmChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetGcmChannelCommandInput): import("@smithy/smithy-client").CommandImpl<GetGcmChannelCommandInput, GetGcmChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
