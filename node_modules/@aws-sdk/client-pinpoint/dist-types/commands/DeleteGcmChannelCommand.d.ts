...
declare const DeleteGcmChannelCommand_base: {
    new (input: DeleteGcmChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteGcmChannelCommandInput, DeleteGcmChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteGcmChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteGcmChannelCommandInput, DeleteGcmChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
