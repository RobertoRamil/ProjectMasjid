...
declare const CreateEmailTemplateCommand_base: {
    new (input: CreateEmailTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<CreateEmailTemplateCommandInput, CreateEmailTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateEmailTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<CreateEmailTemplateCommandInput, CreateEmailTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
