...
declare const DeleteAdmChannelCommand_base: {
    new (input: DeleteAdmChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAdmChannelCommandInput, DeleteAdmChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteAdmChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAdmChannelCommandInput, DeleteAdmChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
