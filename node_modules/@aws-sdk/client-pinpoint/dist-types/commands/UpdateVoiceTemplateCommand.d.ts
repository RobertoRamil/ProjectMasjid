...
declare const UpdateVoiceTemplateCommand_base: {
    new (input: UpdateVoiceTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateVoiceTemplateCommandInput, UpdateVoiceTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateVoiceTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateVoiceTemplateCommandInput, UpdateVoiceTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
