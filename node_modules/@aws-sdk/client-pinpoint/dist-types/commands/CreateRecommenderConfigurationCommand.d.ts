...
declare const CreateRecommenderConfigurationCommand_base: {
    new (input: CreateRecommenderConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateRecommenderConfigurationCommandInput, CreateRecommenderConfigurationCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateRecommenderConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateRecommenderConfigurationCommandInput, CreateRecommenderConfigurationCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
