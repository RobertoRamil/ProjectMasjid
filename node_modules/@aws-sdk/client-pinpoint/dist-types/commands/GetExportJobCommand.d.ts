...
declare const GetExportJobCommand_base: {
    new (input: GetExportJobCommandInput): import("@smithy/smithy-client").CommandImpl<GetExportJobCommandInput, GetExportJobCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetExportJobCommandInput): import("@smithy/smithy-client").CommandImpl<GetExportJobCommandInput, GetExportJobCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
