...
declare const GetJourneyDateRangeKpiCommand_base: {
    new (input: GetJourneyDateRangeKpiCommandInput): import("@smithy/smithy-client").CommandImpl<GetJourneyDateRangeKpiCommandInput, GetJourneyDateRangeKpiCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetJourneyDateRangeKpiCommandInput): import("@smithy/smithy-client").CommandImpl<GetJourneyDateRangeKpiCommandInput, GetJourneyDateRangeKpiCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
