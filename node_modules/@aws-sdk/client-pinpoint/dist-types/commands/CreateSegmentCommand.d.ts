...
declare const CreateSegmentCommand_base: {
    new (input: CreateSegmentCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSegmentCommandInput, CreateSegmentCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateSegmentCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSegmentCommandInput, CreateSegmentCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
