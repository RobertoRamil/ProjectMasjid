...
declare const GetVoiceTemplateCommand_base: {
    new (input: GetVoiceTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<GetVoiceTemplateCommandInput, GetVoiceTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetVoiceTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<GetVoiceTemplateCommandInput, GetVoiceTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
