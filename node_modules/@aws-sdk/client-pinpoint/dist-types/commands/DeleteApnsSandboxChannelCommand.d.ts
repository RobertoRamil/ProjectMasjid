...
declare const DeleteApnsSandboxChannelCommand_base: {
    new (input: DeleteApnsSandboxChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteApnsSandboxChannelCommandInput, DeleteApnsSandboxChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteApnsSandboxChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteApnsSandboxChannelCommandInput, DeleteApnsSandboxChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
