...
declare const CreateAppCommand_base: {
    new (input: CreateAppCommandInput): import("@smithy/smithy-client").CommandImpl<CreateAppCommandInput, CreateAppCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateAppCommandInput): import("@smithy/smithy-client").CommandImpl<CreateAppCommandInput, CreateAppCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
