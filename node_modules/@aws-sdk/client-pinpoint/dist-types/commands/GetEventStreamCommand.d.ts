...
declare const GetEventStreamCommand_base: {
    new (input: GetEventStreamCommandInput): import("@smithy/smithy-client").CommandImpl<GetEventStreamCommandInput, GetEventStreamCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetEventStreamCommandInput): import("@smithy/smithy-client").CommandImpl<GetEventStreamCommandInput, GetEventStreamCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
