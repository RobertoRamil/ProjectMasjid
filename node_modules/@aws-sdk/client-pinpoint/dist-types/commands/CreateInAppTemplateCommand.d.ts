...
declare const CreateInAppTemplateCommand_base: {
    new (input: CreateInAppTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<CreateInAppTemplateCommandInput, CreateInAppTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateInAppTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<CreateInAppTemplateCommandInput, CreateInAppTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
