...
declare const GetJourneyCommand_base: {
    new (input: GetJourneyCommandInput): import("@smithy/smithy-client").CommandImpl<GetJourneyCommandInput, GetJourneyCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetJourneyCommandInput): import("@smithy/smithy-client").CommandImpl<GetJourneyCommandInput, GetJourneyCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
...
export declare class GetJourneyCommand extends GetJourneyCommand_base {
    ...
    protected static __types: {
        ...
        sdk: {
            ...
            output: GetJourneyCommandOutput;
        };
    };
}
