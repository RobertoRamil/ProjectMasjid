...
declare const GetJourneyRunExecutionActivityMetricsCommand_base: {
    new (input: GetJourneyRunExecutionActivityMetricsCommandInput): import("@smithy/smithy-client").CommandImpl<GetJourneyRunExecutionActivityMetricsCommandInput, GetJourneyRunExecutionActivityMetricsCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetJourneyRunExecutionActivityMetricsCommandInput): import("@smithy/smithy-client").CommandImpl<GetJourneyRunExecutionActivityMetricsCommandInput, GetJourneyRunExecutionActivityMetricsCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
