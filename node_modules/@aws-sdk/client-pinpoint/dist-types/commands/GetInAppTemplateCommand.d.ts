...
declare const GetInAppTemplateCommand_base: {
    new (input: GetInAppTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<GetInAppTemplateCommandInput, GetInAppTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetInAppTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<GetInAppTemplateCommandInput, GetInAppTemplateCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
