...
declare const CreateExportJobCommand_base: {
    new (input: CreateExportJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateExportJobCommandInput, CreateExportJobCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateExportJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateExportJobCommandInput, CreateExportJobCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
