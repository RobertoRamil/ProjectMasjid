...
declare const DeleteApnsVoipChannelCommand_base: {
    new (input: DeleteApnsVoipChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteApnsVoipChannelCommandInput, DeleteApnsVoipChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteApnsVoipChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteApnsVoipChannelCommandInput, DeleteApnsVoipChannelCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
