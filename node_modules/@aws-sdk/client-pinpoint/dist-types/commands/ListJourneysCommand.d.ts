...
declare const ListJourneysCommand_base: {
    new (input: ListJourneysCommandInput): import("@smithy/smithy-client").CommandImpl<ListJourneysCommandInput, ListJourneysCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListJourneysCommandInput): import("@smithy/smithy-client").CommandImpl<ListJourneysCommandInput, ListJourneysCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
