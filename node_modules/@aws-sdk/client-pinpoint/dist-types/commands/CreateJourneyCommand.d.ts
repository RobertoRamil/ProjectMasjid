...
declare const CreateJourneyCommand_base: {
    new (input: CreateJourneyCommandInput): import("@smithy/smithy-client").CommandImpl<CreateJourneyCommandInput, CreateJourneyCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateJourneyCommandInput): import("@smithy/smithy-client").CommandImpl<CreateJourneyCommandInput, CreateJourneyCommandOutput, PinpointClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
